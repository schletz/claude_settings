...
1. **Umfang klären.** Eine Datei, ein Modul, ein Subsystem? Im Zweifel den Umfang wählen, den der Nutzer genannt hat, und die direkten Abhängigkeiten als Nebendarsteller behandeln. Ausgabedatei standardmäßig `REFERENCE.md` neben dem dokumentierten Code.
